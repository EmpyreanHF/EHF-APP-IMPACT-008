...
(function empyreanSosModule() {
    ...
    function createSosPostOnFeed(sosData) {
        ...
        postEl.innerHTML = [
            ...
            '    <img src="' + (sosData.avatar || '') + '" alt="' + (sosData.username || '') + "'s Avatar\" onerror=\"this.onerror=null;this.src='https://ui-avatars.com/api/?name='+encodeURIComponent(sosData.username||'U')+'&background=EF4444&color=fff&size=90'\">",
            '  </div>',
    ...
    function createCrisisPostOnFeed(crisisData) {
        ...
        postEl.innerHTML = [
            '<div class="story-header">',
            '  <div class="avatar-placeholder square">',
            '    <img src="' + (crisisData.avatar || '') + '" alt="' + (crisisData.username || '') + "'s Avatar\" onerror=\"this.onerror=null;this.src='https://ui-avatars.com/api/?name='+encodeURIComponent(crisisData.username||'U')+'&background=DC2626&color=fff&size=90'\">",
            '  </div>',
            '  <div class="story-user-info">',
