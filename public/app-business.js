/* =============================================================================
   ...
   app-business.js  |  v3.0  |  Complete rewrite
   =============================================================================
...
(function empyreanBusinessModule() {
    ...
    function _uploadMedia(file) {
        return new Promise(function (resolve, reject) {
            ...
            var fd = new FormData();
            fd.append('file', file);
            fd.append('upload_preset', 'Empyrean_preset');
            fd.append('tags', 'empyrean_business');
            fetch('https://api.cloudinary.com/v1_1/dxcthrgsp/' + (isVid ? 'video' : 'image') + '/upload', {
                method: 'POST', body: fd
            })
        ...
        if (mediaInput && !mediaInput._wired) {
            ...
            mediaInput.addEventListener('change', function () {
                ...
                files.forEach(function (file) {
                    ...
                    wrap.style.cssText = 'position:relative;width:72px;height:72px;border-radius:10px;overflow:hidden;flex-shrink:0;';
                    ...
                    wrap.innerHTML += '<button style="position:absolute;top:3px;right:3px;width:18px;height:18px;'
