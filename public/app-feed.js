...
(function empyreanFeedModule() {
    ...
    function createNewPostElement(text, mediaFiles, authorData, isBusinessPost, retweetData) {
        ...
        el.innerHTML =
            ...
            + '<a class="action-btn comment-btn" data-action="comment" title="Reply"><span class="x-pill"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg><span class="comment-count x-count"></span></span></a>'
            + '<a class="action-btn retweet-btn" data-action="retweet" title="Repost"><span class="x-pill"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg><span class="retweet-count x-count"></span></span></a>'
            + '<a class="action-btn like-btn" data-action="like" title="Like"><span class="x-pill"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="like-count x-count"></span></span></a>'
            + '<a class="action-btn quote-btn" data-action="quote" title="Quote"><span class="x-pill"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><line x1="9" y1="9" x2="9" y2="9"/><line x1="15" y1="9" x2="15" y2="9"/></svg><span class="quote-count x-count"></span></span></a>'
            + '<span class="action-btn view-count-display" title="Views"><svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><rect x="1" y="12" width="4" height="10" rx="1"/><rect x="9" y="7" width="4" height="15" rx="1"/><rect x="17" y="2" width="4" height="20" rx="1"/></svg><span class="view-count x-count"></span></span>'
            + '<a class="action-btn bookmark-btn" data-action="bookmark" title="Bookmark" style="margin-left:auto;"><span class="x-pill"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg></span></a>'
            ...
            + '<a class="action-btn download-media-btn" data-action="download" title="Download"><span class="x-pill"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg><span class="download-count x-count"></span></span></a>'
            + '</div>'
    ...
    /* ── Download count — increment Firestore when user downloads media ──
       app-fixes.js handles the actual file download (watermark etc).
       We intercept the same click here just to write downloadCount: _inc(1). */
    document.addEventListener('click', function (e) {
        var btn = e.target && e.target.closest && e.target.closest('.download-media-btn');
        if (!btn) return;
        var card = btn.closest('[data-post-id]');
        var postId = card && card.dataset.postId;
        if (!postId || !window._firebaseLoaded || !window.fbDb) return;
        try {
            window.fbDb.collection('posts').doc(postId).update({
                downloadCount: (window.firebase && window.firebase.firestore && window.firebase.firestore.FieldValue
                    ? window.firebase.firestore.FieldValue.increment(1) : 1)
            }).catch(function () {});
        } catch (e2) {}
    }, true /* capture phase — fires before app-fixes.js's handler */);
