...
(function EmpyreanFixFinal() {
    ...
    (function fixMarketplaceDashboardAndControls(){
        ...
        /* ── C2: Contact button delegation — DISABLED ──
           This capture-phase listener used to intercept .contact-seller-btn
           clicks before they reached app-marketplace.js's handler (via
           stopImmediatePropagation), expanding a static info panel instead
           of opening the in-marketplace chat overlay. app-marketplace.js's
           §9 EVENT DELEGATION now owns this click exclusively and opens
           _openMarketChatOverlay() directly — no separate inbox redirect,
           no extra nested button to tap. Left here (disabled) rather than
           deleted so the surrounding contact-detail-lookup logic below
           remains available for reference if ever needed again. */
        /*
        document.addEventListener('click',function(e){
